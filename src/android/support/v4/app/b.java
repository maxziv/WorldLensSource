    ...
    implements Runnable
{
    ...
    private void a(int i1, Fragment fragment, String s1, int j1)
    {
        ...
        if (s1 != null)
        {
            ...
            {
                throw new IllegalStateException((new StringBuilder()).append("Can't change tag of fragment ").append(fragment).append(": was ").append(fragment.H).append(" now ").append(s1).toString());
            }
            fragment.H = s1;
        }
        if (i1 != 0)
        {
            ...
            {
                throw new IllegalStateException((new StringBuilder()).append("Can't change container ID of fragment ").append(fragment).append(": was ").append(fragment.F).append(" now ").append(i1).toString());
            }
            fragment.F = i1;
            fragment.G = i1;
        }
    ...
    public z a(int i1, Fragment fragment)
    {
        ...
        if (k)
        {
            ...
            while (c1 != null) 
            {
                if (c1.d != null)
                {
                    ...
                    fragment1.A = i1 + fragment1.A;
                    if (q.a)
                    {
                        Log.v("FragmentManager", (new StringBuilder()).append("Bump nesting of ").append(c1.d).append(" to ").append(c1.d.A).toString());
                    }
                }
                if (c1.i != null)
                {
                    for (int j1 = -1 + c1.i.size(); j1 >= 0; j1--)
                    {
                        ...
                        fragment.A = i1 + fragment.A;
                        if (q.a)
                        {
                            Log.v("FragmentManager", (new StringBuilder()).append("Bump nesting of ").append(fragment).append(" to ").append(fragment.A).toString());
                        }
                    }
...
_L2:
    ...
    public z b(int i1, Fragment fragment, String s1)
    {
        if (i1 == 0)
        {
...
_L9:
        ...
        if (a.g != null)
        {
            ...
            while (i1 < a.g.size()) 
            {
                ...
                if (fragment6 == null || fragment7.G == fragment6.G)
                {
                    ...
                    } else
                    {
                        ...
                        if (k)
                        {
                            fragment7.A = 1 + fragment7.A;
                            if (q.a)
                            {
                                Log.v("FragmentManager", (new StringBuilder()).append("Bump nesting of ").append(fragment7).append(" to ").append(fragment7.A).toString());
                            }
                        }
                        a.a(fragment7, i, j);
                    }
