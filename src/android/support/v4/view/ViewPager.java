...
public class ViewPager extends ViewGroup
{
    ...
    private static final aw af = new aw();
    private static final Comparator c = new am();
    private static final Interpolator d = new an();
    private boolean A;
    private boolean B;
    private int C;
    private int D;
    ...
    private int a(int i1, float f1, int j1, int k1)
    {
        ...
        {
            ap ap1 = (ap)e.get(0);
            ap ap2 = (ap)e.get(-1 + e.size());
            i1 = Math.max(ap1.b, Math.min(i1, ap2.b));
        }
        return i1;
    }
    ...
    private void a(int i1, int j1, int k1, int l1)
    {
        if (j1 > 0 && !e.isEmpty())
        {
            ...
            if (!m.isFinished())
            {
                ...
                ap ap2 = b(i);
                m.startScroll(l2, 0, (int)(ap2.e * (float)i1), 0, i3);
            }
        } else
        {
            ap ap1 = b(i);
    ...
    private void a(int i1, boolean flag, int j1, boolean flag1)
    {
        ...
        if (ap1 != null)
        {
            k1 = (int)((float)getClientWidth() * Math.max(s, Math.min(ap1.e, t)));
        } else
        {
            k1 = 0;
        }
    ...
    private void a(ap ap1, int i1, ap ap2)
    {
        int j1 = h.a();
        ...
        if (ap2 != null)
        {
            ...
            if (i4 < ap1.b)
            {
                float f9 = f1 + (ap2.e + ap2.d);
                int l4 = i4 + 1;
                for (int i5 = 0; l4 <= ap1.b && i5 < e.size(); l4++)
                {
                    ap ap6;
                    for (ap6 = (ap)e.get(i5); l4 > ap6.b && i5 < -1 + e.size(); ap6 = (ap)e.get(i5))
                    {
                        i5++;
                    }
            ...
            if (i4 > ap1.b)
            {
                int j4 = -1 + e.size();
                float f8 = ap2.e;
                for (int k4 = i4 - 1; k4 >= ap1.b && j4 >= 0; k4--)
                {
                    ap ap5;
                    for (ap5 = (ap)e.get(j4); k4 < ap5.b && j4 > 0; ap5 = (ap)e.get(j4))
                    {
                        j4--;
                    }
...
label0:
    ...
    private boolean d(int i1)
    {
        ...
        } else
        {
            ...
            int l1 = ap1.b;
            float f2 = ((float)i1 / (float)j1 - ap1.e) / (f1 + ap1.d);
...
label0:
    ...
    void a()
    {
        ...
        if (flag2)
        {
            ...
            for (j2 = 0; j2 < i2; j2++)
            {
                aq1 = (aq)getChildAt(j2).getLayoutParams();
                if (!aq1.a)
                {
                    aq1.c = 0.0F;
                }
...
_L23:
        ...
        ap2 = (ap)e.get(j2);
        if (ap2.b < i) goto _L9; else goto _L8
_L8:
        if (ap2.b != i)
        {
            break MISSING_BLOCK_LABEL_1294;
...
_L32:
        ...
        if (ap3 == null) goto _L11; else goto _L10
_L10:
        int k3 = j2 - 1;
        r r1;
        int k2;
        ...
        {
            f1 = (2.0F - ap3.d) + (float)getPaddingLeft() / (float)l3;
        }
        i4 = -1 + i;
        f2 = 0.0F;
        j4 = i4;
...
_L14:
        if (ap7 != null) goto _L16; else goto _L13
_L13:
        f3 = ap3.d;
        i5 = k4 + 1;
...
_L20:
        if (ap9 != null) goto _L22; else goto _L18
_L18:
        a(ap3, k4, ap1);
          goto _L11
_L9:
...
_L27:
        ...
        if (ap4 != null && ap4.b == i) goto _L4; else goto _L28
_L28:
        j3 = 0;
_L31:
...
_L29:
        view1 = getChildAt(j3);
        ap5 = a(view1);
        if (ap5 != null && ap5.b == i && view1.requestFocus(byte0)) goto _L4; else goto _L30
_L30:
        j3++;
          goto _L31
        ap2 = null;
...
_L7:
    ...
    public void addView(View view, int i1, android.view.ViewGroup.LayoutParams layoutparams)
    {
        ...
        aq1 = (aq)layoutparams1;
        aq1.a = aq1.a | (view instanceof ao);
        if (w)
        {
            if (aq1 != null && aq1.a)
            {
...
_L2:
        ...
        do
        {
            ...
            {
                ap ap1 = a(view);
                if (ap1 != null && ap1.b == i && view.dispatchPopulateAccessibilityEvent(accessibilityevent))
                {
                    return true;
                }
            }
...
_L3:
    ...
    protected int getChildDrawingOrder(int i1, int j1)
    {
        ...
        return ((aq)((View)ae.get(j1)).getLayoutParams()).f;
    }
...
_L3:
        ArrayList arraylist;
        for (; k2 > ap1.b && j2 < k1; ap1 = (ap)arraylist.get(j2))
        {
            arraylist = e;
            j2++;
        }
...
_L3:
        ...
        if (!aq2.a) goto _L4; else goto _L5
_L5:
        int j6;
        int k6;
        j6 = 7 & aq2.b;
...
_L2:
        ...
        for (int l4 = 0; l4 < i2; l4++)
        {
            ...
            int i5 = l2 + (int)((float)k4 * ap1.e);
            if (aq1.d)
            {
                aq1.d = false;
                view.measure(android.view.View.MeasureSpec.makeMeasureSpec((int)((float)k4 * aq1.c), 0x40000000), android.view.View.MeasureSpec.makeMeasureSpec(k2 - i3 - k3, 0x40000000));
            }
...
_L2:
        ...
        for (i3 = 0; i3 < l2; i3++)
        {
            ...
            aq1 = (aq)view.getLayoutParams();
            if (aq1 == null || !aq1.a)
            {
                view.measure(android.view.View.MeasureSpec.makeMeasureSpec((int)((float)l1 * aq1.c), 0x40000000), v);
            }
        }
    ...
    protected boolean onRequestFocusInDescendants(int i1, Rect rect)
    {
        ...
        for (; k1 != j1; k1 += byte0)
        {
            ...
            ap ap1 = a(view);
            if (ap1 != null && ap1.b == i && view.requestFocus(i1, rect))
            {
                return true;
            }
        }
...
_L3:
        ...
        if (flag2)
        {
            ...
            int i2 = getScrollX();
            ap ap1 = h();
            a(a(ap1.b, ((float)i2 / (float)l1 - ap1.e) / ap1.d, k1, (int)(android.support.v4.view.m.c(motionevent, android.support.v4.view.m.a(motionevent, J)) - H)), true, true, k1);
            J = -1;
            i();
            flag = Q.c() | R.c();
        }
...
_L8:
    ...
    void setOnAdapterChangeListener(ar ar1)
    {
        aa = ar1;
    }

    public void setOnPageChangeListener(as as1)
    {
        W = as1;
    }
    ...
    private class SavedState extends android.view.View.BaseSavedState
    {
        ...
        public static final android.os.Parcelable.Creator CREATOR = android.support.v4.b.a.a(new av());
        int a;
        Parcelable b;
        ClassLoader c;
